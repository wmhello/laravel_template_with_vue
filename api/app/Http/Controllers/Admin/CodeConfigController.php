...
{
    use Tool;
    protected  $model = 'App\Models\CodeConfig';  // 当前模型
    protected  $fillable = [];  // 当前模型可以修改和新增的字段
    protected  $resource = 'App\Http\Resources\CodeConfig'; // 显示个体资源
    protected  $resourceCollection = 'App\Http\Resources\CodeConfigCollection'; // 显示资源集合
