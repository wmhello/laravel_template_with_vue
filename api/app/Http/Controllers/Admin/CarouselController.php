...
{
     use Tool;
    protected  $model = 'App\Models\Carousel';  // 当前模型
    protected  $fillable = ['img', 'url', 'title', 'opentype', 'carousel_note'];  // 当前模型可以修改和新增的字段
    protected  $resource = 'App\Http\Resources\Carousel'; // 显示个体资源
    protected  $resourceCollection = 'App\Http\Resources\CarouselCollection'; // 显示资源集合
