...
{
    use Tool;
    protected  $model = 'App\Models\ArticleCategory';  // 当前模型
    protected  $fillable = ['name', 'note', 'status'];  // 当前模型可以修改和新增的字段
    protected  $resource = 'App\Http\Resources\ArticleCategory'; // 显示个体资源
    protected  $resourceCollection = 'App\Http\Resources\ArticleCategoryCollection'; // 显示资源集合
